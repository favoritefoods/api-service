...
class Thread(Model):
    ...
    forum_name: UnicodeAttribute = UnicodeAttribute(hash_key=True, default=my_default_value)
    ...
    last_post_datetime: UTCDateTimeAttribute = UTCDateTimeAttribute(null=True, attr_name="lpdt")
